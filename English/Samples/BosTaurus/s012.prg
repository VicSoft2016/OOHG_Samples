 ...
 *
 * This sample shows how to resize and image and how
...
PROCEDURE Proc_ON_INIT
   ...
   BT_HMGSetImage( "Win1", "Image1", hBitmap1 ) // Win1.Image1.HBitMap := hBitmap1
   ...
   BT_HMGSetImage( "Win1", "Image2", hBitmap2 ) // Win1.Image2.HBitMap := hBitmap2
...
PROCEDURE Proc_Image( cControlName, cText, aColor )
   ...
   hBitmap := BT_HMGGetImage( "Win1", cControlName )  // hBitmap := GetControlObject( cControlName, "Win1" ):HBitMap
