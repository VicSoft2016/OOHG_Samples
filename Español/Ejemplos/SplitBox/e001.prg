 ...
 *
 * Este ejemplo demuestra como mostrar/ocultar las bandas de
 * un SplitBox y como mostrar/ocultar sus grippers, de modo
 * que no se pueda modificar el tamaño de las bandas.
 * También muestra como averiguar si una banda es visible y
 * si tien un gripper.
 *
